...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.81.03), April 29, 2015, at 22:13
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='G:\\MRI experiment\\MRI Experiment 03-20-15\\CPT-Nback.psyexp',
...
CPT_X_Trials = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath='G:\\MRI experiment\\MRI Experiment 03-20-15\\CPT-Nback.psyexp',
...
writeDataFile(csvDictionary, '%s_CPT_X_results' % expInfo['participant'], ['CPT_X_letters', 'correctButton', 'Response', 'Correct', 'Accuracy', 'Response_Time'], finalLine)
...
writeDataFile(csvDictionary, '%s_Nback_results' % expInfo['participant'], ['Nback_letters', 'correctButton', 'Response', 'Correct', 'Accuracy', 'Response_Time'], finalLine)
win.close()
core.quit()
